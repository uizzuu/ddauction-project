...
public class QQna extends EntityPathBase<Qna> {
    ...
    private static final long serialVersionUID = -1864088664L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QQna qna = new QQna("qna");

    public final com.my.backend.entity.board.QBoard board;
    ...
    public QQna(Class<? extends Qna> type, PathMetadata metadata, PathInits inits) {
        ...
        this.board = inits.isInitialized("board") ? new com.my.backend.entity.board.QBoard(forProperty("board")) : null;
