...
//import com.my.backend.data.entity.Product;
//import com.my.backend.data.entity.User;
//import com.my.backend.dto.portone.PortOnePaymentResponse;
//import com.my.backend.dto.portone.PortOneTokenResponse;
//import com.my.backend.repository.product.ProductRepository;
...
//                .orElseThrow(() -> new IllegalArgumentException("상품을 찾을 수 없습니다."));
//        if (current.getPaymentStatus() == Product.PaymentStatus.PAID) {
...
//        if (paidAmount == null || !product.getPrice().equals(paidAmount.longValue())) {
//            throw new IllegalStateException(
//                    String.format("결제 금액 불일치: 상품가격=%d, 결제금액=%s",
//                            product.getPrice(), String.valueOf(paidAmount)));
//        }
//
