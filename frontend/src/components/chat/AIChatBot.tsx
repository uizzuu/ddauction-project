...
export default function AIChatBot({ isOpen, onClose }: Props) {
  ...
  return (
    <>
      <div
        className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[1000] w-[calc(100vw-2rem)] sm:w-[400px] h-[80vh] sm:h-[650px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden origin-bottom-right"
        style={{
          animation: isClosing
