        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-col">
              <input
                ...
                className={`w-full px-4 py-3 border ${errors.userName ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-[#111] focus:ring-1 focus:ring-[#111] transition-colors`}
              />
            ...
            <div className="flex flex-col">
              <input
                ...
                className={`w-full px-4 py-3 border ${errors.nickName ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-[#111] focus:ring-1 focus:ring-[#111] transition-colors`}
              />
          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-2">
              <input
                ...
                className={`flex-1 px-4 py-3 border ${errors.email ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-[#111] focus:ring-1 focus:ring-[#111] transition-colors`}
              />
              <button
                onClick={sendVerificationEmail}
                className="px-4 py-3 bg-[#333] text-white text-sm whitespace-nowrap hover:bg-black transition-colors"
              >
                인증 메일
              </button>
            </div>
            ...
            {!isEmailVerified && (
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 focus:outline-none focus:border-[#111] focus:ring-1 focus:ring-[#111] transition-colors"
                />
                <button
                  onClick={verifyEmailCode}
                  className="px-4 py-3 border border-[#333] text-[#333] text-sm whitespace-nowrap hover:bg-gray-50 transition-colors"
                >
                  확인
                </button>
              </div>
          ...
          <div className="flex flex-col gap-2">
            <input
              ...
              className={`w-full px-4 py-3 border ${errors.phone ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-[#111] focus:ring-1 focus:ring-[#111] transition-colors`}
            />
            ...
            <input
              ...
              className={`w-full px-4 py-3 border ${errors.birthday ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-[#111] focus:ring-1 focus:ring-[#111] transition-colors bg-white`}
            />
          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-2">
              <input
                ...
                value={form.zipCode}
                readOnly
                className="w-1/3 px-4 py-3 border border-gray-300 bg-gray-50 text-gray-500 focus:outline-none"
              />
              <button
                type="button"
                onClick={handleSearchAddress}
                className="flex-1 px-4 py-3 border border-[#333] text-[#333] text-sm hover:bg-gray-50 transition-colors"
              >
                주소 검색
              </button>
            </div>
            <input
              ...
              value={form.address}
              readOnly
              className="w-full px-4 py-3 border border-gray-300 bg-gray-50 text-gray-500 focus:outline-none"
            />
            <input
              type="text"
              placeholder="상세주소"
              ...
              className="w-full px-4 py-3 border border-gray-300 focus:outline-none focus:border-[#111] focus:ring-1 focus:ring-[#111] transition-colors"
            />
          ...
          <div className="flex flex-col gap-2">
            <input
              ...
              className={`w-full px-4 py-3 border ${errors.password ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-[#111] focus:ring-1 focus:ring-[#111] transition-colors`}
            />
            ...
            <input
              ...
              className={`w-full px-4 py-3 border ${errors.passwordConfirm ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-[#111] focus:ring-1 focus:ring-[#111] transition-colors`}
            />
          ...
          <button
            ...
            className={`w-full py-4 mt-4 font-bold text-white transition-colors ${!isEmailVerified ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#03c75a] hover:bg-[#02b351]'}`}
          >
            가입하기
          </button>
